...
axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.timeout = 2000;
...
const fetchTeachers = async () => {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/users/teachers');
...
const fetchUnassigned = async () => {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/users/unassigned');
    data.unassigned = response.data;
  } catch (err) {
    console.error('Failed to fetch unassigned students (GET /api/users/unassigned)', err);
  }
};
...
const createStudent = async studentName => {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/users', {
      name: studentName
    });
    ...
    error.innerText = err.response ? err.response.data.message : 'Request Timed Out';
  }
};

const deleteTeacher = async teacherId => {
  try {
    await axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`/api/users/${teacherId}`);
    const {
      mentees
    ...
    console.error(`Failed to delete user (DELETE /api/users/${teacherId})`, err);
    error.innerText = err.response ? err.response.data.message : 'Request Timed Out';
  }
};
...
const deleteMentee = async (menteeId, teacherId) => {
  try {
    ...
    await axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`/api/users/${menteeId}`);
    teacher.mentees = teacher.mentees.filter(mentee => mentee.id !== menteeId);
    render();
  } catch (err) {
...
const deleteUnassignedStudent = async studentId => {
  try {
    await axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`/api/users/${studentId}`);
    data.unassigned = data.unassigned.filter(student => student.id !== studentId);
    render();
  } catch (err) {
    console.error(`Failed to delete user (DELETE /api/users/${studentId})`, err);
    error.innerText = err.response ? err.response.data.message : 'Request Timed Out';
  }
};
...
const makeTeacherAStudent = async id => {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(`/api/users/${id}`, {
      userType: 'STUDENT'
    });
    const student = response.data;
...
const makeMenteeATeacher = async (menteeId, teacherId) => {
  ...
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(`/api/users/${menteeId}`, {
      userType: 'TEACHER'
    });
...
const assignMentor = async (studentId, teacherId) => {
  ...
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(`/api/users/${studentId}`, {
      mentorId: teacherId
    });
    const student = response.data;
    data.unassigned = data.unassigned.filter(_student => _student.id !== studentId);
